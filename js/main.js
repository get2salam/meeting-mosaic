const SPEC = {
  "slug": "meeting-mosaic",
  "title": "Meeting Mosaic",
  "description": "Turn scattered meeting notes into structured decisions, actions, and follow-ups.",
  "lede": "Capture the real outcomes from meetings with clearer owners, next moves, and follow-up dates.",
  "heroEyebrow": "Meeting synthesis workspace",
  "boardTitle": "Meeting mosaic board",
  "boardSubtitle": "A local-first board for turning meeting fragments into decisions and action.",
  "accent": "Meetings become useful when clarity, ownership, and follow-up are visible immediately after the call.",
  "itemLabel": "meeting fragment",
  "itemPluralLabel": "Meeting fragments",
  "labels": {
    "title": "Fragment",
    "note": "Meeting note",
  ...
  "textOne": {
    "label": "Owner",
    "default": "Who owns the next move"
  },
  "textTwo": {
    "label": "Next move",
  ...
  "defaults": {
    "note": "Capture the part of the meeting that matters after the call is over."
  },
  "stats": {
    "totalLabel": "Fragments",
    "motionLabel": "Being followed",
    "dueLabel": "Follow-ups due"
  },
  "insights": {
    "topLabel": "Most important takeaway",
    "dateLabel": "Next follow-up",
    "metricLabel": "Clearest item"
  },
  "queue": {
    "eyebrow": "Follow-up queue",
    "title": "What needs a response next",
    "empty": "Closed items stay out of the follow-up queue."
  },
  "mix": {
    "eyebrow": "Meeting mix",
    "title": "Where the meeting energy landed"
  },
  "emptyTitle": "No meeting fragments yet",
  "emptyBody": "Add decisions, actions, risks, and follow-ups from recent meetings.",
  "actions": [
    {
      "id": "send-follow-up",
      ...
      "days": 2,
      "fromToday": true,
      "toast": "Queued the next follow-up."
    },
    {
      "id": "sharpen",
      "label": "Sharpen clarity",
      "mode": "advance",
      "metricDelta": 1,
      "toast": "Raised the clarity on this meeting item."
    },
    {
      "id": "close",
      "label": "Mark closed",
      ...
      "days": 0,
      "fromToday": true,
      "toast": "Closed this meeting item."
    }
  ],
  "theme": {
    "primary": "#a78bfa",
  ...
  "items": [
    {
      ...
      "metric": 8,
      "textOne": "Abdul",
      "textTwo": "Confirm the anchor package",
      "date": "2026-04-25",
      "note": "The team aligned on positioning, but the exact pilot price still needs a clean final call."
    },
    {
      "title": "Client wants async updates",
      "category": "Follow-up",
      "state": "Waiting",
      "score": 7,
      "effort": 2,
      "metric": 7,
      "textOne": "Project lead",
      "textTwo": "Send weekly format sample",
      "date": "2026-04-26",
      "note": "The ask was simple and should reduce future status-chasing if handled well."
    },
    {
      "title": "Risk around dependency timing",
      "category": "Risk",
      "state": "Captured",
      "score": 8,
      "effort": 4,
      "metric": 5,
      "textOne": "Engineering",
      "textTwo": "Validate vendor timeline",
      "date": "2026-04-29",
      "note": "The risk is manageable, but only if the dependency gets checked early."
    }
  ]
};
