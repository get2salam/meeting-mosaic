  ...
  "tagline": "Turn scattered meeting notes into structured decisions, actions, and follow-ups.",
  "domainLabel": "notes",
  "itemLabel": "note",
  "emptyTitle": "No meeting notes yet",
  "emptyBody": "Capture the decisions, actions, and context worth keeping.",
  "seedTitle": "Decision mosaic",
  "seedSubtitle": "A simple note board for meetings that should actually lead somewhere.",
  "categories": [
    "Decision",
    "Action",
    "Risk",
  ...
  "items": [
    {
      ...
      "score": 9,
      "effort": 2,
      "note": "The top-line promise changes from features to time saved in the first hour."
    },
    {
      "title": "Send recap with owners",
      "category": "Follow-up",
      "state": "Captured",
      "score": 8,
      "effort": 1,
      "note": "Fast recap prevents ambiguity from growing overnight."
    },
    {
      "title": "Resolve integration risk",
      "category": "Risk",
      "state": "Clarifying",
      "score": 7,
      "effort": 4,
      "note": "Need one technical owner and one fallback path before the next milestone."
    }
  ]
};
